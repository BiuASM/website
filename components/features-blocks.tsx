        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">资产数据可视化</h4>
              <p className="text-gray-600 text-center">清晰直观的视图展示，<br/>提高决策效率</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">指纹数据覆盖广</h4>
              <p className="text-gray-600 text-center">6000+精心整理的指纹数据，<br/>  准确识别未知资产</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">漏洞响应迅速</h4>
              <p className="text-gray-600 text-center">从解读到检测规则到发布上线，<br/>针对新风险响应迅速</p>
            </div>
